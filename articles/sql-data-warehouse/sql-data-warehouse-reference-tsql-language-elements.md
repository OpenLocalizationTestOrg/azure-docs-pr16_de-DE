<properties
   ...
   description="Liste mit Links zu Bezug Inhalt für die Transact-SQL-Sprache-Elemente für SQL Data Warehouse verwendet."
...
- [Benennungskonventionen Objekt](https://msdn.microsoft.com/library/ms175874.aspx)
...
- [Die Eigenschaft problemumgehung Identität](https://msdn.microsoft.com/library/ms186775.aspx)
- [DRUCKEN](https://msdn.microsoft.com/library/ms176047.aspx)
- [VERWENDUNG](https://msdn.microsoft.com/library/ms188366.aspx)

## <a name="batches-control-of-flow-and-variables"></a>Stapel, der Fluss Steuerelements und Variablen

- [BEGINNEN... ENDE](https://msdn.microsoft.com/library/ms190487.aspx)
- [SEITENUMBRUCH](https://msdn.microsoft.com/library/ms181271.aspx)
- [DEKLARIEREN@local_variable](https://msdn.microsoft.com/library/ms188927.aspx)
- [WENN FOLGENDES ZUTRIFFT: SONST](https://msdn.microsoft.com/library/ms182717.aspx)
...
- [VERSUCHEN SIE ES... FANGEN](https://msdn.microsoft.com/library/ms175976.aspx)
- [WEILE](https://msdn.microsoft.com/library/ms178642.aspx)

## <a name="operators"></a>Operatoren
- [+ (Hinzufügen)](https://msdn.microsoft.com/library/ms178565.aspx)
...
## <a name="wildcard-characters-to-match"></a>Platzhalterzeichen Zeichen zu entsprechen
...
- [> = (großartig als oder gleich)](https://msdn.microsoft.com/library/ms181567.aspx)
- [< = (kleiner als oder gleich)](https://msdn.microsoft.com/library/ms174978.aspx)
- [<> (Nicht gleich)](https://msdn.microsoft.com/library/ms176020.aspx)
- [! = (Nicht gleich)](https://msdn.microsoft.com/library/ms190296.aspx)
- [UND](https://msdn.microsoft.com/library/ms188372.aspx)
- [ZWISCHEN](https://msdn.microsoft.com/library/ms187922.aspx)
- [VORHANDEN IST](https://msdn.microsoft.com/library/ms188336.aspx)
- [IN](https://msdn.microsoft.com/library/ms177682.aspx)
- [[NOT] IST NULL](https://msdn.microsoft.com/library/ms188795.aspx)
- [WIE](https://msdn.microsoft.com/library/ms179859.aspx)
- [NICHT](https://msdn.microsoft.com/library/ms189455.aspx)
- [ODER](https://msdn.microsoft.com/library/ms188361.aspx)

### <a name="bitwise-operators"></a>Bitweisen Operatoren

- [& (Bitweises und)](https://msdn.microsoft.com/library/ms174965.aspx)
- [| (Bitweises "oder")](https://msdn.microsoft.com/library/ms186714.aspx)
- [^ (Bitweises exklusives oder)](https://msdn.microsoft.com/library/ms190277.aspx)
- [~ (Bitweises NOT)](https://msdn.microsoft.com/library/ms173468.aspx)
- [^ = (Bitweises exklusiv oder gleich)](https://msdn.microsoft.com/library/cc627413.aspx)
- [| = (Bitweises oder gleich)](https://msdn.microsoft.com/library/cc627409.aspx)
- [& = (bitweises und gleich)](https://msdn.microsoft.com/library/cc627427.aspx)
...
- [FALL](https://msdn.microsoft.com/library/ms181765.aspx)
- [CAST und konvertieren](https://msdn.microsoft.com/library/ms187928.aspx)
- [OBERGRENZE](https://msdn.microsoft.com/library/ms189818.aspx)
- [ZEICHEN](https://msdn.microsoft.com/library/ms187323.aspx)
...
- [SICH SPALTENNAME](https://msdn.microsoft.com/library/ms174974.aspx)
- [COLLATIONPROPERTY](https://msdn.microsoft.com/library/ms190305.aspx)
- [VERKETTEN](https://msdn.microsoft.com/library/hh231515.aspx)
- [COS](https://msdn.microsoft.com/library/ms188919.aspx)
- [COT](https://msdn.microsoft.com/library/ms188921.aspx)
- [ZÄHLEN](https://msdn.microsoft.com/library/ms175997.aspx)
...
- [FUNKTION DATUMAUSTEILEN](https://msdn.microsoft.com/library/hh213228.aspx)
...
- [UNTERGRENZE](https://msdn.microsoft.com/library/ms178531.aspx)
...
- [POSITIVEN](https://msdn.microsoft.com/library/hh231256.aspx)
- [LAST_VALUE](https://msdn.microsoft.com/library/hh231517.aspx)
- [LEAD](https://msdn.microsoft.com/library/hh213125.aspx)
- [NACH LINKS](https://msdn.microsoft.com/library/ms177601.aspx)
- [LÄNGE](https://msdn.microsoft.com/library/ms190329.aspx)
- [LOG](https://msdn.microsoft.com/library/ms190319.aspx)
- [LOG10](https://msdn.microsoft.com/library/ms175121.aspx)
- [UNTEREN](https://msdn.microsoft.com/library/ms174400.aspx)
...
- [OBJEKTNAME](https://msdn.microsoft.com/library/ms186301.aspx)
...
- [BOGENMAß (RADIANT)](https://msdn.microsoft.com/library/ms189742.aspx)
- [ZUFALLSZAHL](https://msdn.microsoft.com/library/ms177610.aspx)
- [RANG](https://msdn.microsoft.com/library/ms176102.aspx)
- [ERSETZEN](https://msdn.microsoft.com/library/ms186862.aspx)
- [REPLIZIERT](https://msdn.microsoft.com/library/ms174383.aspx)
- [UMGEKEHRTE RICHTUNG](https://msdn.microsoft.com/library/ms180040.aspx)
- [RECHTS](https://msdn.microsoft.com/library/ms177532.aspx)
- [RUNDEN](https://msdn.microsoft.com/library/ms175003.aspx)
- [SOLL](https://msdn.microsoft.com/library/ms186734.aspx)
...
- [MELDEN SIE SICH](https://msdn.microsoft.com/library/ms188420.aspx)
...
- [LEERZEICHEN](https://msdn.microsoft.com/library/ms187950.aspx)
...
- [STABWN](https://msdn.microsoft.com/library/ms176080.aspx)
- [STR](https://msdn.microsoft.com/library/ms189527.aspx)
- [VON INHALTEN](https://msdn.microsoft.com/library/ms188043.aspx)
- [TEILZEICHENFOLGE](https://msdn.microsoft.com/library/ms187748.aspx)
...
## <a name="diagnostic-sessions"></a>Diagnose Sitzungen

- [ERSTELLEN VON DIAGNOSE SITZUNG](https://msdn.microsoft.com/library/mt204029.aspx)
...
## <a name="set-statements"></a>Festlegen von Anweisungen
...
- [FESTLEGEN VON ANSI_NULLS](https://msdn.microsoft.com/library/ms188048.aspx)
- [SET ANSI_PADDING](https://msdn.microsoft.com/library/ms187403.aspx)
- [FESTLEGEN VON ANSI_WARNINGS](https://msdn.microsoft.com/library/ms190368.aspx)
...
- [DATEFIRST FESTLEGEN](https://msdn.microsoft.com/library/ms181598.aspx)
- [DATUMSFORMAT FESTLEGEN](https://msdn.microsoft.com/library/ms189491.aspx)
- [SET FMTONLY](https://msdn.microsoft.com/library/ms173839.aspx)
- [FESTLEGEN VON IMPLICIT_TRANSACITONS](https://msdn.microsoft.com/library/ms187807.aspx)
- [SET LOCK_TIMEOUT](https://msdn.microsoft.com/library/ms189470.aspx)
- [FESTLEGEN VON NUMBERIC_ROUNDABORT](https://msdn.microsoft.com/library/ms188791.aspx)
- [FESTLEGEN VON QUOTED_IDENTIFIER](https://msdn.microsoft.com/library/ms174393.aspx)
- [ZEILENANZAHL FESTLEGEN](https://msdn.microsoft.com/library/ms188774.aspx)
- [TEXTSIZE FESTLEGEN](https://msdn.microsoft.com/library/ms186238.aspx)
- [FESTLEGEN TRANSAKTION GRAD DER ISOLATION AN](https://msdn.microsoft.com/library/ms173763.aspx)
