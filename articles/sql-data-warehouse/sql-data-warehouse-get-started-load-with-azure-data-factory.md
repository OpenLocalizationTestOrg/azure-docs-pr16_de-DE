...
Nachdem Sie alle Teile bereit haben, sind Sie bereit, um Beispieldaten in Ihrer Azure-Blob-Speicher zu kopieren.
...
2. Klicken auf 'Neue Dataset' und dann auf 'Azure BLOB-Speicher' Ihrer Speicher mit Ihrer Daten Factory verknüpfen.  Sie können die unter Skript zum Definieren von Daten in Azure Blob-Speicher:
...
3. Nun können wir unser Dataset für SQL Data Warehouse definieren. Zunächst auf die gleiche Weise, indem Sie auf 'Neue Dataset', 'Azure SQL-Data Warehouse'.
