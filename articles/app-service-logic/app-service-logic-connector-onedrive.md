<properties
    pageTitle="Verwenden der OneDrive-Verbinder in Logik Apps | Microsoft Azure-App-Verwaltungsdienst"
    description="So erstellen und Konfigurieren der app OneDrive Verbinder oder API und diese in einer app Logik in Azure-App-Dienst verwenden"
    authors="msftman"
    manager="erikre"
    editor=""
    services="logic-apps"
...
# <a name="weve-improved-the-onedrive-connector"></a>Wir haben den OneDrive-Verbinder verbessert. 
...
- [Erfahren Sie mehr über diese neue Verbinder](../connectors/connectors-create-api-onedrive.md)
