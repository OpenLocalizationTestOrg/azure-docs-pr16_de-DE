<properties
   pageTitle="Verwenden den Vertrieb Verbinder in Logik Apps | Microsoft Azure-App-Verwaltungsdienst"
   description="So erstellen und Konfigurieren der app Vertrieb Verbinder oder API und diese in einer app Logik in Azure-App-Dienst verwenden"
   services="logic-apps"
...
# <a name="weve-improved-the-salesforce-connector"></a>Wir haben den Vertrieb Verbinder verbessert. 
...
- [Erfahren Sie mehr über diese neue Verbinder](../connectors/connectors-create-api-salesforce.md)
