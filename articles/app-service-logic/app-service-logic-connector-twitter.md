<properties
   pageTitle="Verwenden den Verbinder Twitter in Logik Apps | Microsoft Azure-App-Verwaltungsdienst"
   description="So erstellen und Konfigurieren der app Twitter-Verbinder oder API und diese in einer app Logik in Azure-App-Dienst verwenden"
   services="logic-apps"
...
# <a name="weve-improved-the-twitter-connector"></a>Wir haben den Verbinder Twitter verbessert. 
...
- [Erfahren Sie mehr über diese neue Verbinder](../connectors/connectors-create-api-twitter.md)
