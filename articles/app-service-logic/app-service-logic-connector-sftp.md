<properties
    pageTitle="Verwenden den Verbinder SFTP in Logik Apps | Microsoft Azure-App-Verwaltungsdienst"
    description="So erstellen und Konfigurieren der app SFTP Verbinder oder API und diese in einer app Logik in Azure-App-Dienst verwenden"
    authors="msftman"
    manager="erikre"
    editor=""
    services="logic-apps"
...
# <a name="weve-improved-the-sftp-connector"></a>Wir haben den Verbinder SFTP verbessert. 
...
- [Erfahren Sie mehr über diese neue Verbinder](../connectors/connectors-create-api-sftp.md)
