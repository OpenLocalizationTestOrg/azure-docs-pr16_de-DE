<properties
   pageTitle="Verwenden den SMTP-Connector in Logik Apps | Microsoft Azure-App-Verwaltungsdienst"
   description="So erstellen und Konfigurieren der app SMTP-Connector oder API und diese in einer app Logik in Azure-App-Dienst verwenden"
   services="logic-apps"
...
- [Erfahren Sie mehr über diese neue Verbinder](../connectors/connectors-create-api-smtp.md)
