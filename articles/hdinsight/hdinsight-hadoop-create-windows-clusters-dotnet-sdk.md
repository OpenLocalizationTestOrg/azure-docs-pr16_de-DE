<properties
   pageTitle="Erstellen von Windows-basiertem Hadoop Cluster in HDInsight mit .NET SDK | Microsoft Azure"
    description="Erfahren Sie, wie HDInsight Cluster für .NET SDK mit Azure-HDInsight zu erstellen."
   services="hdinsight"
   documentationCenter=""
   tags="azure-portal"
   authors="mumian"
...
# <a name="create-windows-based-hadoop-clusters-in-hdinsight-using-net-sdk"></a>Erstellen von Windows-basiertem Hadoop Cluster in HDInsight mit .NET SDK

[AZURE.INCLUDE [selector](../../includes/hdinsight-selector-create-clusters.md)]


Erfahren Sie, wie HDInsight Cluster mit .NET SDK erstellen. Für die Clustererstellung von anderen Tools und Features klicken Sie auf der Registerkarte wählen Sie am oberen Rand dieser Seite oder finden Sie unter [Methoden zur Erstellung](hdinsight-provision-clusters.md#cluster-creation-methods).
...
HDInsight .NET SDK stellt .NET Client-Bibliotheken, die für die Arbeit mit HDInsight aus einer .NET Framework-Anwendung zu erleichtern. Gehen Sie folgendermaßen vor, erstellen Sie eine Visual Studio, und fügen Sie den Code für einen Cluster erstellen.

Die Anwendung erfordert eine Azure Ressourcengruppe und des Standardkontos-Speicher.  [Anhang A](#appx-a-create-dependent-components) enthält ein PowerShell-Skript zum Erstellen von der abhängigen Komponenten.

**So erstellen Sie eine Visual Studio Console-Anwendung**

1. Erstellen Sie eine neue c# in Visual Studio.
2. Führen Sie den folgenden Befehl aus Nuget in die Nuget-Paket-Verwaltungskonsole.
...
7. Drücken Sie **F5** , um die Anwendung ausführen. Ein Fenster Console sollte öffnen und den Status der Anwendung angezeigt. Sie werden auch aufgefordert, geben Sie Ihre Kontoanmeldeinformationen ein Azure. Sie können mehrere Minuten um ein HDInsight Cluster erstellen.
...
##<a name="appx-a-create-dependent-components"></a>A-AppX erstellen abhängige Komponenten

Die folgenden Azure PowerShell, Skript sein kann, verwenden, um die abhängigen Komponenten erforderlich, die von der Anwendung .NET in diesem Lernprogramm erstellen.
