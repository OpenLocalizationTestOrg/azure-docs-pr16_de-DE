...
In diesem Beispiel verwenden wir die aufzeichnen SetName "@" zum Erstellen eines MX-Eintrags in der Zone Spitze (in diesem Fall "contoso.com"). Dies ist im Allgemeinen MX-Einträge.
...
Wenn Sie in einer Zone Stammverzeichnis einen SRV-Eintrag erstellen, geben Sie einfach *_service* und *_protocol* in den Namen des Datensatzes. Es ist nicht erforderlich, um einzuschließen "@" in den Namen des Datensatzes.
...
### <a name="create-a-txt-record-set-with-a-single-record"></a>Erstellen Sie einen TXT-Eintrag mit einem einzelnen Datensatz festlegen
