> [AZURE.SELECTOR]
- [Linux-basierten](hdinsight-hadoop-provision-linux-clusters.md)
- [(Übersicht)](hdinsight-provision-clusters.md)
...
- [Cloud-Vorlagen](hdinsight-hadoop-create-windows-clusters-arm-templates.md)
